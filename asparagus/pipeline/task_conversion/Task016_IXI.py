...
def convert(path: str = get_source_path(), subdir: str = "IXI", processes=12):
    task_name = "Task016_IXI"
    ...
    bvals_DWI, bvecs_DWI = get_bvals_and_bvecs_v2(files_DWI, join(source_dir, "bvals.txt"), join(source_dir, "bvecs.txt"))
