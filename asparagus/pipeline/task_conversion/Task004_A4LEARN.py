...
def convert(path: str = get_source_path(), subdir: str = "A4", processes=12):
    task_name = "Task004_A4LEARN"
    file_suffix = ".nii"  # e.g. ".nii.gz" or ".nii"
    exclusion_patterns = ["fmri", "fMRI"]  # e.g. "func" or "fmri"
    DWI_patterns = ["DWI"]  # e.g. "DWI" or "dwi"
    PET_patterns = ["Florbetapir", "Flortaucipir"]  # e.g. "PET" or "pet"
