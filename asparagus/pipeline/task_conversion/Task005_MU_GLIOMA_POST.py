...
def convert(path: str = get_source_path(), subdir: str = "MU_Glioma_Post", processes=12):
    task_name = "Task005_MU_GLIOMA_POST"
    file_suffix = ".nii.gz"  # e.g. ".nii.gz" or ".nii"
    exclusion_patterns = ["Mask", "mask", "tumor"]  # e.g. "func" or "fmri"
    ...
    ### Uncomment the following line to detect bvals and bvecs in the same directory as the images
