...
def convert(path: str = get_source_path(), subdir: str = "BCBM_RadioGenomics", processes=12):
    task_name = "Task031_BCBM_RadioGenomics"
    file_suffix = ".nii.gz"  # e.g. ".nii.gz" or ".nii"
    exclusion_patterns = ["mask"]  # e.g. "func" or "fmri"
