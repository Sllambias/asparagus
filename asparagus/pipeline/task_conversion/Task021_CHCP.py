...
def convert(path: str = get_source_path(), subdir: str = "CHCP", processes=12):
    task_name = "Task021_CHCP"
    file_suffix = ".nii.gz"  # e.g. ".nii.gz" or ".nii"
    exclusion_patterns = ["fMRI"]  # e.g. "func" or "fmri"
    DWI_patterns = ["Diffusion"]  # e.g. "DWI" or "dwi"
